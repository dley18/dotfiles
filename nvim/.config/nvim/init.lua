...
-- Move selected lines up/down (insanely useful)
...
-- Paste over selection WITHOUT losing your register
-- (default behavior replaces your clipboard with the deleted text)
